<h1><u>blvdiff (formerly blvflag) - MacOS/Linux</u></h1>
...
Note: This version is for MacOS/Linux only.

For Windows support: <a href="https://github.com/rylansedlacek/blvflag-windows"> blvdiff </a>
